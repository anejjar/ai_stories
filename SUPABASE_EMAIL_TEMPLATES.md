...
This document contains the email templates to use in your Supabase dashboard.
...
- ✅ Brand-consistent styling (matches your app's design)
- ✅ Clear call-to-action button
- ✅ Fallback text link for email clients that don't support buttons
- ✅ Professional yet friendly tone
- ✅ Security messaging about why verification is needed
...
- The gradient colors (#667eea to #764ba2) match your app's purple theme
- The template is tested to work with major email clients (Gmail, Outlook, Apple Mail, etc.)
- Make sure to enable "Email confirmations" in Supabase: Authentication > Settings > Email Auth
