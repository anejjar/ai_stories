...
export function ProMaxUpsell({
  title = "Upgrade to PRO MAX",
  description = "Create beautiful illustrated story books with your child as the hero!",
  features = [
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-600 italic">
            ✨ Join thousands of parents creating magical illustrated stories for their children!
          </p>
        </div>
      </div>
    </div>
